				...
				<div className="mt-6 mb-10 grid grid-cols-12 grid-rows-4 gap-6 sm:mt-10 sm:mb-12 md:mb-14">
					<a href="https://github.com/darektoa" className="pt-[100%] relative w-full h-auto bg-gradient-to-b from-[rgba(0,180,216,.75)] to-[rgba(105,48,195,.75)] rounded-2xl flex flex-col justify-center items-center row-span-3 col-span-7 md:rounded-3xl">
						<div className="w-full h-full absolute top-0 flex flex-col justify-center items-center">
							...
							<p className="p-2 text-2xl text-white xs:text-4xl sm:text-5xl md:text-6xl">Github</p>
						</div>
					</a>
					<a href="https://instagram.com/abdulftthh" className="relative pt-[100%] w-full bg-[rgba(255,255,255,60)] shadow-sunny shadow-[rgba(118,118,118,0.25)] rounded-2xl flex flex-col justify-center items-center row-span-2 col-span-5 md:rounded-3xl">
						<div className="w-full h-full absolute top-0 flex flex-col justify-center items-center">
							<i className="icon-instagram-blue text-5xl xs:text-6xl sm:text-7xl md:text-8xl"></i>
							<p className="p-2 text-sm text-[#0077B6] xs:text-xl sm:text-2xl md:text-3xl">Instagram</p>
						</div>
					</a>
					<a href="https://linkedin.com/in/abdulftthh" className="relative pt-[100%] w-full bg-[rgba(255,255,255,60)] shadow-sunny shadow-[rgba(118,118,118,0.25)] rounded-2xl flex flex-col justify-center items-center row-span-2 col-span-5 md:rounded-3xl">
						<div className="w-full h-full absolute top-0 flex flex-col justify-center items-center">
							<i className="icon-linkedin-blue text-5xl xs:text-6xl sm:text-7xl md:text-8xl"></i>
							<p className="p-2 text-sm text-[#0077B6] xs:text-xl sm:text-2xl md:text-3xl">LinkedIn</p>
						</div>
					</a>
