	...
	return (
		<section className="
			...
			<div className="container">
				<h1 className="text-3xl font-extrabold text-[#0077B6] xs:text-4xl">IT'S ME, ABDUL</h1>
				<p className="xs:text-xl">I'm an enthusiastic programmer 🙌</p>
				<p className="xs:text-xl">Visit and find me on:</p>
				...
				<div className="mt-6 mb-10 grid grid-cols-12 grid-rows-4 gap-6">
					<a href="https://github.com/darektoa" className="pt-[100%] relative w-full h-auto bg-gradient-to-b from-[rgba(0,180,216,.75)] to-[rgba(105,48,195,.75)] rounded-2xl flex flex-col justify-center items-center row-span-3 col-span-7">
						<div className="w-full h-full absolute top-0 flex flex-col justify-center items-center">
							<i className="icon-github-white text-8xl xs:text-9xl"></i>
							<p className="p-2 text-2xl text-white xs:text-4xl">Github</p>
						</div>
					</a>
					<a href="https://instagram.com/abdulftthh" className="relative pt-[100%] w-full bg-[rgba(255,255,255,60)] shadow-sunny shadow-[rgba(118,118,118,0.25)] rounded-2xl flex flex-col justify-center items-center row-span-2 col-span-5">
						<div className="w-full h-full absolute top-0 flex flex-col justify-center items-center">
							<i className="icon-instagram-blue text-5xl xs:text-6xl"></i>
							<p className="p-2 text-sm text-[#0077B6] xs:text-xl">Instagram</p>
						</div>
					</a>
					<a href="https://linkedin.com/in/abdulftthh" className="relative pt-[100%] w-full bg-[rgba(255,255,255,60)] shadow-sunny shadow-[rgba(118,118,118,0.25)] rounded-2xl flex flex-col justify-center items-center row-span-2 col-span-5">
						<div className="w-full h-full absolute top-0 flex flex-col justify-center items-center">
							<i className="icon-linkedin-blue text-5xl xs:text-6xl"></i>
							<p className="p-2 text-sm text-[#0077B6] xs:text-xl">LinkedIn</p>
						</div>
					</a>
					<a href="https://github.com/darektoa" className="w-full h-full p-3 bg-[rgba(255,255,255,60)] rounded-xl flex justify-center items-center col-span-7 self-end shadow-sunny shadow-[rgba(116,0,184,.25)] xs:rounded-2xl">
						<i className="icon-filedown-blue text-2xl xs:text-3xl"></i>
						<p className="ml-3 text-sm text-[#0077B6] font-bold xs:text-lg">Donwload CV</p>
					</a>
				</div>

				<p className="text-[rgba(0,118,182,0.8)] text-center text-sm xs:text-base sm:text-lg">I'm a software engineering graduate, let's talk about software. Don't ask any privacy, I really love the privacy 😍</p>
			</div>
		</section>
	);
}
