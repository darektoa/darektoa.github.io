const About = () => {
	return (
		<section className="
			...
			sm:pb-20 lg:min-h-[38rem] lg:box-content lg:after:top-[10%] lg:after:right-[5%]">
			<div className="container h-full flex flex-col items-center lg:pt-368 lg:items-start relative">
				<h1 className="text-3xl font-extrabold text-[#0077B6] xs:text-4xl md:text-5xl lg:mt-36 lg:text-4xl">IT'S ME, ABDUL</h1>
				<p className="xs:text-xl md:text-2xl lg:text-xl">I'm an enthusiastic programmer 🙌</p>
				...
				<p className="max-w-[80%] text-[rgba(0,118,182,0.8)] text-center text-sm xs:text-base sm:text-lg md:text-xl lg:text-left lg:max-w-[25rem]">I'm a software engineering graduate, let's talk about software. Don't ask any privacy, I really love the privacy <span className="inline-block motion-safe:animate-flutter">😍</span></p>
			</div>
		</section>
	);
}
