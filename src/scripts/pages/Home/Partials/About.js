	...
	return (
		<section className="
			...
			<div className="container">
				...
				<p className="text-[rgba(0,118,182,0.8)] text-center text-sm xs:text-base">I'm a software engineering graduate, let's talk about software. Don't ask any privacy, I really love the privacy 😍</p>
			</div>
		</section>
	);
}
