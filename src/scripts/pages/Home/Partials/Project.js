...
const ProjectCard = (props) => {
    ...
    return (
        <div className="mb-6 rounded-2xl overflow-hidden shadow-sunny shadow-[rgba(118,118,118,0.25)] md:w-[49%] md:flex-shrink-0">
            <img src={data.thumbnail || 'https://source.unsplash.com/random/300x300?tech'} alt="Thumbnail" className="w-full h-48 object-cover border border-solid border-b-[#00B4D8] bg-slate-300 sm:h-64 md:h-48" />
