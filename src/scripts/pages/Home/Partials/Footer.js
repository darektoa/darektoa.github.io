...
const Footer = () => {
    return (
        <div className="w-full pt-16 flex flex-col items-center">
            <div className="w-32 h-32 bg-contain bg-no-repeat bg-center sm:w-48 sm:h-48" style={{ backgroundImage: `url(${duckCool})` }}></div>
            ...
            <p className="text-sm text-[#0077B6] text-center leading-tight sm:leading-tight sm:text-base">Made with ❤️ Motivated <br/> on my first love, Designed by Me</p>
        </div>
    );
};
